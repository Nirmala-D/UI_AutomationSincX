...
public class TC_018 extends BaseClass{
 ...
 Login();
	  ...
	  // find element for Recurrence(MONTH) filter
	   driver.findElement(By.xpath("//input[@placeholder=\"Recurrence\"][\"MONTH\"] "));
      driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
	   ...
	   WebElement RecurrenceMONTH = driver.findElement(By.xpath("(//div[@class='_13hqe44'])[1]"));
	   Assert.assertEquals(RecurrenceMONTH.isDisplayed(), true);
  }
}
